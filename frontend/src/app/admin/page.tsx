...
const adminSections = [
	...
	},
	{
		...
		description: "Khóa hoặc mở khóa tài khoản, duyệt đối tác và giám sát hàng đợi xét duyệt.",
		href: "/admin/users",
		icon: Shield,
	},
	{
		title: "Kiểm duyệt nội dung",
		description: "Duyệt nội dung toàn sàn, xử lý nội dung vi phạm và giám sát trạng thái hiển thị.",
		href: "/admin/reviews",
			...
			<div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
				...
				<Button
					...
					className={cn(
						...
						"active:scale-95",
						"rounded-md px-4 h-9.5 shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
					)}
				>
