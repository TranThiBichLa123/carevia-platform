...
import com.carevia.service.AccountService;
...
import com.carevia.shared.util.JsonViewUtils;
...
public class AccountController {
    ...
    @Authenticated
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> getProfile() {
    ...
    @AdminOnly
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> getAccountById(
    ...
    @Operation(
            summary = "Approve staff account (Admin only)",
            description = "Approve a pending staff account and activate it. Only accessible by administrators."
    )
    @PatchMapping("/admin/accounts/{id}/approve")
    @ApiMessage("Approve staff account (Admin only)")
    @AdminOnly
    ...
    @Operation(
            summary = "Reject staff account (Admin only)",
            description = "Reject a pending staff account with a reason. Only accessible by administrators."
    )

    @PatchMapping("/admin/accounts/{id}/reject")
    @ApiMessage("Reject staff account (Admin only)")
    @AdminOnly
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> rejectStaffAccount(
            @Parameter(description = "ID of the staff account to reject", required = true)
            @PathVariable Long id,
        ...
        String ip = Optional.ofNullable(request.getHeader("X-Forwarded-For")).orElse(request.getRemoteAddr());
        AccountProfileResponse result = accountService.rejectStaffAccount(id, rejectRequest.getReason(), ip);
    ...
    @AdminOnly
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> changeAccountStatus(
    ...
    @AdminOnly
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> suspendAccount(
    ...
    @AdminOnly
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> unlockAccount(
    ...
    @AdminOnly
    public ResponseEntity<com.carevia.shared.dto.ApiResponse<Object>> deactivateAccount(
