...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Detailed client information response")
public class ClientDetailResponse {
    ...
    @Schema(description = "Client username", example = "client123")
    ...
    @Schema(description = "Account role", example = "CLIENT")
    private Role role;
